...
#define SHKMyAppURL				@"http://www.ort.edu.ar"
 ...
 */
#define SHKTwitterConsumerKey		@"nMRjgmX3YSwPePGy8K7qA"
#define SHKTwitterSecret			@"cg9gO8gU0IRjt74XbOeQX1L0KD8PcrXNNI8tdIxLA"
#define SHKTwitterCallbackUrl		@"http://www.ort.edu.ar" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"martingof12" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
